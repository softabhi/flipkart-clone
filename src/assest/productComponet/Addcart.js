        ...
        <>
            <div className="container-fluid" style={{  height: "100vh" }}>
                <div className="row " >
                    ...
                    <div className="col-lg-5 shadow-lg p-3 mb-5 bg-white rounded mt-5" style={{ height: "70vh" }}>
                        ...
                        <div className="row d-flex align-items-center border-bottom border-primary border-top border-primary p-2">
                            <div className="col-2 ">
                                <img className='img-fluid' src={pic.img1} alt="" />
                            </div>
                            <div className="col-2">
                                <h6>Shirt</h6>
                                <h7>Cotton T-Shirt</h7>
                            </div>
                            <div className="col-4">
                                <div className="row">
                                    <div className="col-3 ">
                        ...
                        <div className="row d-flex align-items-center border-bottom border-primary p-2">
                            <div className="col-2 ">
                                <img className='img-fluid' src={pic.img1} alt="" />
                            </div>
                            <div className="col-2">
                    ...
                    <div className="col-lg-3 shadow-lg p-3 mb-5 bg rounded mt-5" style={{ background: "#e0e0e0", height: "70vh" }}>
